...
To do so, we first need to define a subject for each happy moment. A very intuitive technique for such an analysis is the "tf-idf" technique, because it measures the importance of word to a specific document. Therefore, the most important word would define the document best. This "importance score" is computed by multiplying two different measures:
...
By multiplying the two, we get the tf-idf function, which essentially provides the importance of a word to it's document and in other words, tells us the "subject" or the "reason" for the happy moment. 
```{r, warning=FALSE, echo = FALSE, include= FALSE}
